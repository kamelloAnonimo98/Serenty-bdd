 ...
 */
@WithTag("CALCULATOR")
public class OpenCalculatorAddProjectTest extends AbstractTest {
    ...
    public void setup() {
        ...
        additionValues.setFirstValue(config.getFirstValue());
        additionValues.setSecondValue(config.getSecondValue());
    ...
    public void openCalculatorProjectTest() {
        ...
        UserActions.sleep();
        then(actor).should(
              seeThat(resultValueExist,is(ConstantsCalculator.RESULT_ADD))
        );
