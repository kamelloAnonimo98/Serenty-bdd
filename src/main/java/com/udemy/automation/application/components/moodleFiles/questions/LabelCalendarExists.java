...
public class LabelCalendarExists implements Question<String> {
    ...
    public String answeredBy(Actor actor) {
        UserActions.isVisible(component.getLabelCalendar());
        return UserActions.isTextPresent(component.getLabelCalendar(), actor);
    }
}