...
public class ButtonAccederExists implements Question<String> {
    ...
    public String answeredBy(Actor actor) {
        UserActions.isVisible(component.getButtonAcceder());
        return UserActions.isTextPresent(component.getButtonAcceder(), actor);
    }
}