...
public class TitleHistoryExist implements Question<String> {
    ...
    public String answeredBy(Actor actor) {
        UserActions.isVisible(component.getHistoryLabel());
        return UserActions.isTextPresent(component.getHistoryLabel(),actor);
    }
