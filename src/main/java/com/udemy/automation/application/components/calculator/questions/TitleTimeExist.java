...
public class TitleTimeExist implements Question<String> {
    ...
    public String answeredBy(Actor actor) {
        UserActions.isVisible(component.getTimeLabel());
        return UserActions.isTextPresent(component.getTimeLabel(),actor);
    }
